...
SIFT_BED_FILE = "SIFT_del_sites.txt"
...
def extract_genotypes(bed_file):
    ...
    for chr in CHROMOSOMES:
        ...
        chr_real_bed = f"dchr{chr}_regions.bed"
        chr_sift_bed = f"dchr{chr}_sift.bed"
        chr_intersect_bed_with_allele = f"dchr{chr}_intersect_with_allele.bed"
        ...
        # Sort the BED files
        sorted_chr_real_bed = f"dsorted_chr{chr}_regions.bed"
        sorted_chr_sift_bed = f"dsorted_chr{chr}_sift.bed"
        ...
        temp_bed = f"dtemp_chr{chr}_positions.txt"
        ...
        temp_output = f"dchr{chr}_genotypes.txt"
        cmd = [
...
real_output_file = "sifl_del_real_regions_genotypes.csv"
...
random_output_file = "sift_del_random_regions_genotypes.csv"
