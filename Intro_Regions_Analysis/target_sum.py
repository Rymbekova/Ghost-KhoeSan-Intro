...
def process_individual(individual, group1_ids, group2_ids):
    bed_file = f"pairwisediff/{individual}_overlap.bed"
...
if __name__ == "__main__":
    ...
    group1_ids = ["HGDP_HGDP01029", "KSP062", "KSP063", "KSP065", "KSP067", "KSP069", "KSP092", "KSP096", "KSP103", "KSP105", "KSP106", "KSP111", "KSP116", "KSP124", "KSP134", "KSP137", "KSP139", "KSP140", "KSP146", "KSP150", "KSP152", "KSP154", "KSP155", "KSP224", "KSP225", "KSP228"] # target
    ...
    final_diff_csv_path = f"{output_directory}/total_diff_sums_target_individuals.csv"
