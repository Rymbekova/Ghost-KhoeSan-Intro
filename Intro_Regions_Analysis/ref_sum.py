...
def count_diff_with_group2(bed_file, vcf_file, group2_ids, individual2):
...
def process_individual(individual2, bed_files, group2_ids):
    ...
    for chrom in range(1, 23):
        ...
        result = count_diff_with_group2(bed_file, vcf_file, group2_ids, individual2)
...
if __name__ == "__main__":
    ...
    bed_files = {
        ...
        "HGDP_HGDP01284": "pairwisediff/KSP067_overlap.bed",
        "SGDP_LP6005441-DNA_E07": "pairwisediff/KSP069_overlap.bed",
        "SGDP_LP6005441-DNA_F07": "pairwisediff/KSP092_overlap.bed",
        "SGDP_LP6005442-DNA_A02": "pairwisediff/KSP096_overlap.bed",
        "SGDP_LP6005442-DNA_A10": "pairwisediff/KSP103_overlap.bed",
        "SGDP_LP6005442-DNA_B02": "pairwisediff/KSP105_overlap.bed",
        "SGDP_LP6005442-DNA_B10": "pairwisediff/KSP106_overlap.bed",
        "SGDP_LP6005442-DNA_G10": "pairwisediff/KSP111_overlap.bed",
        "SGDP_LP6005442-DNA_G11": "pairwisediff/KSP116_overlap.bed",
        "SGDP_LP6005442-DNA_H10": "pairwisediff/KSP124_overlap.bed",
        "SGDP_SS6004475": "pairwisediff/KSP134_overlap.bed",
        "SGDP_SS6004470": "pairwisediff/KSP137_overlap.bed",
        "HGDP_DNK02": "pairwisediff/KSP139_overlap.bed",
        "NA19017": "pairwisediff/KSP140_overlap.bed",
        "PNP010": "pairwisediff/KSP146_overlap.bed",
        "PNP011": "pairwisediff/KSP150_overlap.bed",
        "PNP012": "pairwisediff/KSP152_overlap.bed",
        "PNP013": "pairwisediff/KSP154_overlap.bed",
        "PNP014": "pairwisediff/KSP155_overlap.bed",
        "PNP030": "pairwisediff/KSP224_overlap.bed",
        "PNP031": "pairwisediff/KSP225_overlap.bed",
        "PNP032": "pairwisediff/KSP228_overlap.bed"
    }
    ...
    final_diff_csv_path = f"{output_directory}/total_diff_sums_all_ref_individuals.csv"
